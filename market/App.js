...
class PantallaInicio extends React.Component {
  ...
  Entrar() {
    if (!!this.state.usuario && !!this.state.contrasena) {
      fetch(
        'https://guia10rs181977.000webhostapp.com/apiusuario.php?comando=autenticar&usuario=' +
          this.state.usuario +
          '&contrasena=' +
...
class listarProductos extends React.Component {
  ...
  cargarRegistros() {
    console.log('Prueba');
    fetch('https://guia10rs181977.000webhostapp.com/api.php?comando=listar', {
      method: 'GET',
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaDetalle extends React.Component {
  ...
  Actualizar() {
    fetch(
      'https://guia10rs181977.000webhostapp.com/api.php?comando=editar&nombre=' +
        this.state.nombre +
        '&descripcion=' +
  ...
  Eliminar() {
    fetch(
      'https://guia10rs181977.000webhostapp.com/api.php?comando=eliminar&id=' +
        this.state.id,
      {
        method: 'GET',
      }
...
class PaginaAgregar extends React.Component {
  ...
  Guardar() {
    fetch(
      'https://guia10rs181977.000webhostapp.com/api.php?comando=agregar&nombre=' +
        this.state.nombre +
        '&descripcion=' +
        this.state.descripcion +
        '&cantidad=' +
